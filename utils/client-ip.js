...
function getClientIp(req) {
	...
	// In production, NEVER trust X-Forwarded-For on localhost
	// In demo mode, allow it for testing purposes only
	if (CONFIG.DEMO_MODE && (realIp === "0.0.0.0" || realIp === "::1" || realIp === "127.0.0.1")) {
